    ...
    <div className={`${styles.flexStart} bg-background`}>
      <div className={`${styles.boxWidth}`}>
        <section className={`flex md:flex-row flex-col ${styles.paddingY}`}>
          ...
          <p className={`${styles.paragraph}`}>If you have any questions or would just like to get in touch fill out the form below or call us on 01969 667017</p>
          <form ref={form} onSubmit={sendEmail} className='bg-background shadow-md rounded px-8 pt-6 pb-8 mb-4 mt-[25px]'>
            ...
            <input required type="email" name="user_email" className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline' />
            <label className='block text-gray-700 text-sm font-bold mb-2 mt-2'>Contact Number</label>
            <input required type="tel" name="user_number" className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline' />
            <label className='block text-gray-700 text-sm font-bold mb-2 mt-2'>Message</label>
            <textarea required name="message" className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline min-h-[200px] ' />
